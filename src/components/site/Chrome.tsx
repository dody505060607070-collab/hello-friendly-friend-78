  ...
  return (
    <div className="fixed bottom-20 end-4 z-40 flex flex-col items-center gap-2 sm:bottom-28 sm:end-5 sm:gap-3">
      ...
      <a
        ...
        className="grid size-10 place-items-center rounded-full bg-primary text-primary-foreground shadow-float transition-transform hover:scale-105 sm:size-13"
      >
        <svg viewBox="0 0 32 32" aria-hidden="true" className="size-6 fill-current sm:size-7">
