...
export const Route = createFileRoute("/_authenticated/tasks/normal")({
  head: () => ({
    meta: [
      { title: "المهام العادية | الرشودي للعقارات" },
      { name: "description", content: "المهام الإدارية والتشغيلية المسندة لفريق الرشودي." },
      { property: "og:title", content: "المهام العادية | الرشودي للعقارات" },
