...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "الشروط والأحكام | مثراء العقارية" },
      {
        name: "description",
        content:
          "الشروط والأحكام الخاصة باستخدام موقع مثراء العقارية وعرض العقارات وطلبات الإيجار والبيع.",
      },
      { property: "og:title", content: "الشروط والأحكام | مثراء العقارية" },
      { property: "og:description", content: "شروط استخدام موقع مثراء العقارية وخدماته." },
...
const sections = [
  {
    ...
    body: "الموقع مخصص لعرض العقارات وطلبها والتواصل مع مؤسسة مثراء العقارية. يُمنع استخدامه لأي غرض مخالف للأنظمة السعودية أو نسخ محتواه تجاريًا دون إذن.",
  },
  {
  ...
  },
  {
    ...
    body: "الشعار والصور والنصوص في الموقع ملك لمؤسسة مثراء العقارية أو مستخدمة بترخيص، ولا يجوز إعادة نشرها دون إذن كتابي.",
  },
  {
    title: "تعديل الشروط",
    ...
    <SiteLayout>
      <article className="mx-auto max-w-3xl px-4 py-14">
        ...
        <p className="mt-3 text-[13.5px] leading-7 text-muted-foreground">
          باستخدامك موقع مثراء العقارية فإنك توافق على الشروط التالية.
        </p>
